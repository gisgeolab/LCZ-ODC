...
def import_ucp():
  ...
  file_basepath = '/home/asi/data/layers/ucp'
...
measurements:""")
  ...
  print(colored('All UCP products have been updated into the ODC','green'))

  for file in list_files:
      filename='/home/asi/data/layers/ucp/UCP.yaml'
      date_uuid = '20230209'
      print(file)
      src = rasterio.open(file)
      xmin,ymin,xmax,ymax = src.bounds
...
id: 30000000-0000-0000-0000-0000"""+ str(date_uuid) +"""
...
properties:
  ...
  print(colored('All UCP products have been imported into the ODC','green'))
